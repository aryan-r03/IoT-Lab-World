...
// LED pins {ONLY 2, INCREASE ACCORDINGLY}
...
// Increae the LED-buttons , if using more LEDs
...
void setup() {
  ...
  pinMode(LED1, OUTPUT);
  pinMode(LED2, OUTPUT);
  // Increae the LED-functions , if using more LEDs
...
// Increae the LED-functions , is using more LEDs
